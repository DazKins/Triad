...
public class ClientChunkManager implements IWorldAccess {
	...
	public void updateData(ChunkData d) {
		ChunkCoordinate coords = d.getCoords();
	...
	public void render(Camera cam) {
		...
		int ix0 = (int) Math.floor((x0 / div) - 1.0f);
		int ix1 = (int) Math.floor((x1 / div) + 1.0f);
		int iy0 = (int) Math.floor((y0 / div) - 1.0f);
		int iy1 = (int) Math.floor((y1 / div) + 1.0f);
